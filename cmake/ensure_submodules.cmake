...
if(GIT_FOUND AND EXISTS "${PROJECT_SOURCE_DIR}/.git")
    ...
    if(GIT_SUBMODULE)
        ...
        execute_process(COMMAND ${GIT_EXECUTABLE} submodule update --init
                        WORKING_DIRECTORY ${PROJECT_SOURCE_DIR}/lib/pico-sdk
                        RESULT_VARIABLE GIT_SUBMOD_RESULT)
        if(NOT GIT_SUBMOD_RESULT EQUAL "0")
...
if(NOT EXISTS "${PROJECT_SOURCE_DIR}/lib/pico-sdk/CMakeLists.txt")
    message(FATAL_ERROR "pico-sdk was not downloaded! ${PROJECT_SOURCE_DIR}/lib/pico-sdk/CMakeLists.txt GIT_SUBMODULE was turned off or failed. Please update submodules and try again.")
endif()

if(NOT EXISTS "${PROJECT_SOURCE_DIR}/lib/ssm-runtime/Makefile")
